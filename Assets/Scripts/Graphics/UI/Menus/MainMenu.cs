	...
	public static class MainMenu
	{
		...
		{
			FormatButtonString("New Game"),
			FormatButtonString("Open Game"),
		...
		static readonly string authorString = "Created by: Adetoro Akinola";
		static readonly string inspireString = "Inspired by: Sebastian Lague";
		...
		public static void Draw()
		{
			...
			const string title = "DIGITAL LOGIC QUEST";
		...
		static void DrawLoadProjectScreen()
		{
			...
			else if (buttonIndex == openButtonIndex) activeMenuScreen = MenuScreen.Levels; // open project
		}
		...
		static void DrawAboutScreen()
		{
			...
			UI.DrawText(
				"Digital Logic Quest is a puzzle-based learning game inspired by Sebastian Lague’s Digital Logic Sim.",
				theme.font,
				theme.fontSize,
		...
		{
			Main.CreateOrLoadProject(SelectedProjectName, string.Empty);
		}
		...
		static void DrawVersionInfo()
		{
			...
			UI.DrawText(inspireString, theme.FontRegular, theme.FontSizeRegular, datePos, Anchor.TextCentreRight, col);
		}
